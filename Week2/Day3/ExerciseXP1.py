...
# Goal: Implement dunder methods for a Currency class 
# to handle string representation, integer conversion, 
...
# and dunder methods which will output the results 
# below.
...
# print(c1 + c3)
# TypeError: Cannot add between Currency type
#   <dollar> and <shekel>
# comment the print above before you run the file for 
#   next exercises (since the error will crash your 
#   file)

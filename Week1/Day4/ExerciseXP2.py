...
# Goal: Create a function that displays a message
...
#   The function needs to output a message like 
#   “One of my favorite books is <title>”.
# Step 3: Call the Function with an Argument
#    Call the favorite_book() function and provide a 
...
favorite_book("Children of the King")